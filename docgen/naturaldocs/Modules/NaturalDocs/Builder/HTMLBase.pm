...
sub EndBuild #(hasChanged)
    ...
    if (NaturalDocs::Settings->HighlightCode() || NaturalDocs::Settings->HighlightAnonymous())
		...
		NaturalDocs::File->Copy($self->DHTiny4NDJavaScriptFile(), $prettifyOutput);
...
#
#   Function: DHTinyJavaScriptFile
#
#   Returns the location of the dhtiny.js JavaScript file.
#
sub DHTinyJavaScriptFile
    {
    my $self = shift;
    return NaturalDocs::File->JoinPaths( $self->JavaScriptDirectory().'../../../', 'dhtiny.js' );
    };
    #
    
#   Function: DHTiny4NDJavaScriptFile
#
#   Returns the location of the dhtiny.js JavaScript file.
#
sub DHTiny4NDJavaScriptFile
    {
    my $self = shift;
    return NaturalDocs::File->JoinPaths( $self->JavaScriptDirectory(), 'dhtiny4d.js' );
    };
