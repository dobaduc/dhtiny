...
$dh.newClass("DHRichCanvas", DHEvent, {    
    ...
    setProp: function(p, value) {
        ...
        if (this.canvas && this.roundrectProps && $dh.browser.ie) {
            ...
            if (size.width * size.height == 0)
                this.canvas.setAttribute("arcsize","0");
            else {
                if (size.width < size.height)
                    this.canvas.arcsize = ""+(this.roundrectProps.radius/size.width);
                else
                    this.canvas.arcsize = ""+(this.roundrectProps.radius/size.height);
          }*/
            ...
            /*var bdcolor = $dh.getCssProp(this.canvas, "borderColor");
            var bdwidth = $dh.getCssProp(this.canvas, "borderWidth");
            this.canvas.setAttribute("strokeweight",""+parseInt(bdwidth,10));
            this.canvas.setAttribute("stroke",""+bdcolor);*/
        }
    },
    ...
    getProp: function(p) {
        ...
        else if (("|left|top|width|height|right|bottom|fontSize|padding|margin|lineHeight|zIndex").indexOf("|" + p) >= 0) {
