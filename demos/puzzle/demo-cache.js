...
$dh.newClass("MAGICVIDEOPUZZLE", {
	...
	onLoadedVideo: function(obj) { // Loaded video for puzzle
		...
		this.Grid.canvas.style.display = "none";
		...
		this.Grid.canvas.style.display = "";
		
		// Remove cache video
		//var pvideo = $dh.el(this.Grid.id + "_videocache");
		//pvideo.parentNode.removeChild(pvideo);
